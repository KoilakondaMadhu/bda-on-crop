...
def predictcrop():
	...
	def recomend(stat,dist,mont):
		...
		season2=""
		season4=""
		if(month=="January" or month=="December" or month=="November" or month=="February" or month=="March"):season='Rabi       '
		if(month=="October" or month=="November"):season1='Autumn     '
		if(month=="June" or month=="July" or month=="August" or month=="September"):season2='Kharif     '
		if(month=="March" or month=="April" or month=="May"):	 season4='Summer     '
		season3='Whole Year '
